...
<body class="login-page d-flex align-items-center justify-content-center min-vh-100 bg-light">
    <div class="card shadow-sm rounded-4 login-card">
        <div class="card-body p-4 text-center">
            <h1 class="h3 mb-3 text-danger">ODC Student Hotel Duty Management</h1>
            ...
            <div class="mt-3 text-muted small">Role-based dashboard access for Admin, Placement Head, Student, Manager, Hotelier.</div>
        </div>
    </div>
</body>
</html>
